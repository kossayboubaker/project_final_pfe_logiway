...
setData({
    ...
    numbers: {
        ...
        currencies: {
            ...
            SLL: {
                displayName: "Ego Leone obodo Sierra Leone (1964—2022)",
                "displayName-count-other": "Ego Leone obodo Sierra Leone (1964—2022)"
            },
            SOS: {
            ...
            XCG: {
                displayName: "Ego Guilder Caribbean",
                "displayName-count-other": "Ego Guilder Caribbean",
                symbol: "Cg."
            },
            XOF: {
            ...
            ZWG: {
                displayName: "Ego Ọlaọcha Zimbabwe",
                "displayName-count-other": "Ego Ọlaọcha Zimbabwe"
            }
        },
        localeCurrency: "NGN"
    },
