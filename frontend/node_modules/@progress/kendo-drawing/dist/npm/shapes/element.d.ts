...
export abstract class Element {
   ...
   * <demo metaUrl="drawing/drawing-dom-elements/customizing-the-appearance/element-clip/" height="120"></demo>
   * {% endplatform_content %}
   ...
   *
   * {% platform_content angular %}
   * <demo metaUrl="drawing/drawing-dom-elements/customizing-the-appearance/element-clip-clear/" height="120"></demo>
   * {% endplatform_content %}
   * {% platform_content react %}
   * {% meta %}
   * {% embed_file element-clip/app.tsx preview %}
   ...
   *
   * {% platform_content angular %}
   * <demo metaUrl="drawing/drawing-dom-elements/customizing-the-appearance/element-opacity/" height="120"></demo>
   * {% endplatform_content %}
   * {% platform_content react %}
   * {% meta %}
   ...
   *
   * {% platform_content angular %}
   * <demo metaUrl="drawing/drawing-dom-elements/customizing-the-appearance/element-transform/" height="120"></demo>
   * {% endplatform_content %}
   * {% platform_content react %}
   * {% meta %}
   ...
   *
   * {% platform_content angular %}
   * <demo metaUrl="drawing/drawing-dom-elements/customizing-the-appearance/element-visibility/" height="120"></demo>
   * {% endplatform_content %}
   * {% platform_content react %}
   * {% meta %}
